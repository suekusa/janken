...
'''
Tkinterを使って実装した体力制のじゃんけんゲームです。
じゃんけんに勝つと相手の体力を減らしていき、先に相手の体力を0にした方が勝ちとなります。
ゲームのスタート画面ではそれぞれ体力やグーチョキパーの攻撃力が違うキャラと、ゲーム中に一度だけ使える魔法を選択することができます。
敵のキャラと魔法はランダムで選出され、こちらのキャラの能力に合わせて出す手の確率を変化させてきます。
'''
